...
const CommunityUpdates = () => {
  return (
    <div id='Testimonial' className=' w-full flex flex-col gap-4 items-center' >
        {/* Top */}
        <div className=' flex flex-col w-[1110px] min-h-[124px] items-center'>
        ...
        <div className=' px-36 w-full flex justify-around gap-8'>
            <div className=' w-[368px] h-[366px]'>
                <div className=' w-[368px] h-[286px] flex flex-col items-center rounded-lg relative'>
                    <img src={Image1} alt="" />
                    <div className='p-4 min-w-[317px] min-h-[176px] flex flex-col gap-4 rounded-lg bg-white absolute top-45 shadow-lg'></div>
                </div>
            </div>
            <div className=' w-[368px] h-[366px]'>
                <div className=' w-[368px] h-[286px] flex flex-col items-center rounded-lg relative'>
                    <img src={Image2} alt="" />
                    <div className='p-4 min-w-[317px] min-h-[176px] flex flex-col gap-4 rounded-lg bg-white  absolute top-45 shadow-lg'>
                        <div>
                            <h4 className='font-semibold 
                            text-xl leading-7 text-grayHead text-center'></h4>
